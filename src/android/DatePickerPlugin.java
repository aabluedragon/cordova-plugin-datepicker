...
public class DatePickerPlugin extends CordovaPlugin {
    ...
    private static DatePickerDialog lastDatePickerDialog;
    private static TimePickerDialog lastTimePickerDialog;
    ...
    public boolean execute(final String action, final JSONArray data, final CallbackContext callbackContext) {
        ...
        if(action.equals("date")) {
            ...
            try {
                lastDatePickerDialog.dismiss();
            } catch(Exception e) {}
            try {
                lastTimePickerDialog.dismiss();
            } catch(Exception e) {}
        }
    ...
    private Runnable runnableTimeDialog(final DatePickerPlugin datePickerPlugin,
        ...
        return new Runnable() {
            ...
            public void run() {
                ...
                lastTimePickerDialog = timeDialog;
    ...
    private Runnable runnableDatePicker(
        ...
        return new Runnable() {
            ...
            public void run() {
                ...
                lastDatePickerDialog = dateDialog;
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
